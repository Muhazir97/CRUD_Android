...
public class ListViewAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        tv_nama.setText(listMahasiswa.get(position).getNAMA());
        tv_fakultas.setText(listMahasiswa.get(position).getFAKULTAS());
        tv_jurusan.setText(listMahasiswa.get(position).getJURUSAN());
        tv_semester.setText(listMahasiswa.get(position).getSEMESTER());
